 ...
 */
@ApiStatus.Internal
public final class LegacySoftWrapModelImpl extends SoftWrapModelImpl {

  private static final Logger LOG = Logger.getInstance(LegacySoftWrapModelImpl.class);
  ...
  LegacySoftWrapModelImpl(@NotNull EditorImpl editor) {
    this.editor = editor;
