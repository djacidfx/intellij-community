...
public abstract class KeymapsTestCase extends KeymapsTestCaseBase {
  ...
  private static final Map<String, String[][]> DEFAULT_DUPLICATES = Map.ofEntries(
    Map.entry("$default", new String[][]{
      ...
      {"DOWN",                     "EditorDown", "Terminal.SelectBlockBelow", "JupyterSelectCellBelowCommandModeAction"},
      ...
      {"INSERT",                   "EditorToggleInsertState", "UsageView.Include", "DomCollectionControl.Add",
                                   "XDebugger.NewWatch"},
      {"RIGHT",                    "EditorRight", "Terminal.InsertInlineCompletionItem", "Terminal.InsertInlineCompletion"},
      ...
      {"UP",                       "EditorUp", "Terminal.SelectBlockAbove", "JupyterSelectCellAboveCommandModeAction"},
      ...
      {"alt K",                    "JupyterNotebookMoveCellUpCommandModeAction", "NotebookMoveCellUpAction", "PyCellMoveUpAction"},
      {"alt J",                    "SelectNextOccurrence", "NotebookMoveCellDownAction", "JupyterNotebookMoveCellDownCommandModeAction", "PyCellMoveDownAction"},
      ...
      {"control C",                "$Copy", "Terminal.ClearPrompt", "Terminal.CopySelectedText", "org.jetbrains.r.console.RConsoleViewImpl.RInterruptAction",
                                   "JupyterNotebookCopyCellCommandModeAction"},
      {"control D",                "EditorDuplicate", "Diff.ShowDiff", "Compare.SameVersion", "CompareTwoFiles", "SendEOF", "Terminal.CloseSession",
                                   "FileChooser.GotoDesktop", "org.jetbrains.r.console.RConsoleViewImpl.REofAction"},
      ...
      {"control DOWN",             "EditorScrollDown", "EditorLookupDown", "MethodOverloadSwitchDown", "NotebookSelectCellBelowAction",
                                   "Terminal.SelectPrompt", "Terminal.LineDown"},
      ...
      {"control SPACE",            "CodeCompletion", "ChangesView.SetDefault", "Console.TableResult.SelectColumn"},
      ...
      {"control UP",               "EditorScrollUp", "EditorLookupUp", "MethodOverloadSwitchUp", "NotebookSelectCellAboveAction",
                                   "Terminal.SelectLastBlock", "Terminal.SelectBlockAbove", "Terminal.LineUp"},
      ...
      {"control alt G",            "DatabaseView.SqlGenerator", "org.jetbrains.plugins.ruby.rails.actions.generators.RailsRunGeneratorPopupAction",
                                   "GoGenerateFileAction"},
      ...
      {"control alt R",            "Diff.ApplyLeftSide", "org.jetbrains.plugins.ruby.tasks.rake.actions.RakeRunTaskPopupAction", "Django.RunManageTaskAction"},
    ...
    Map.entry("Mac OS X 10.5+", new String[][]{
      ...
      {"alt R",                    "Django.RunManageTaskAction", "org.jetbrains.plugins.ruby.tasks.rake.actions.RakeRunTaskPopupAction"},
      ...
      {"control C",                "Terminal.ClearPrompt", "org.jetbrains.r.console.RConsoleViewImpl.RInterruptAction"},
      {"control D",                "Debug", "Terminal.CloseSession", "org.jetbrains.r.console.RConsoleViewImpl.REofAction"},
      ...
      {"meta DOWN",                "EditSource", "NotebookSelectCellBelowAction", "Terminal.SelectPrompt", "Terminal.LineDown"},
      ...
      {"meta UP",                  "ShowNavBar", "FileChooser.GoToParent", "NotebookSelectCellAboveAction", "Terminal.SelectLastBlock", "Terminal.SelectBlockAbove", "Terminal.LineUp"},
      {"meta ENTER",               "Console.Execute.Multiline", "DirDiffMenu.SynchronizeDiff.All", "Docker.RemoteServers.StartComposeService", "EditorSplitLine", "GraphQLExecuteEditor",
                                   "NotebookInsertCodeCellAction", "SplitChooser.Duplicate", "Terminal.SmartCommandExecution.Run", "ViewSource", "org.jetbrains.r.actions.RunSelection"},
    ...
    Map.entry("Mac OS X", new String[][]{
      ...
      {"alt R",                    "Django.RunManageTaskAction", "org.jetbrains.plugins.ruby.tasks.rake.actions.RakeRunTaskPopupAction"},
      {"control C",                "Terminal.ClearPrompt", "org.jetbrains.r.console.RConsoleViewImpl.RInterruptAction"},
      {"control D",                "Terminal.CloseSession", "org.jetbrains.r.console.RConsoleViewImpl.REofAction"},
      {"control DOWN",             "EditorLookupDown", "MethodDown"},
      {"control ENTER",            "Generate", "NotebookRunCellAction", "NewElement", "PyExecuteCellAction"},
      {"control F5",               "Refresh", "Rerun"},
      ...
      {"meta SLASH",               "CommentByLineComment", "FileChooser.GoToRoot", "Graph.ActualSize"},
      {"meta T",                   "Terminal.NewTab", "Vcs.UpdateProject"},
      {"meta UP",                  "EditorScrollUp", "FileChooser.GoToParent", "MethodOverloadSwitchUp", "Terminal.SelectLastBlock", "Terminal.SelectBlockAbove", "Terminal.LineUp", "NotebookSelectCellAboveAction"},
      {"meta ENTER",               "Console.Execute.Multiline", "DirDiffMenu.SynchronizeDiff.All", "Docker.RemoteServers.StartComposeService", "EditorSplitLine", "GraphQLExecuteEditor",
                                   "NotebookInsertCodeCellAction", "SplitChooser.Duplicate", "Terminal.SmartCommandExecution.Run", "ViewSource", "org.jetbrains.r.actions.RunSelection"},
      {"shift control TAB",        "Switcher", "Diff.FocusOppositePane"},
      {"shift meta C",             "CopyPaths", "DatabaseView.CopyDdlAction", "WebInspector.Browser.Selection.Toggle", "org.intellij.plugins.markdown.ui.actions.styling.ToggleCodeSpanAction"},
    ...
    Map.entry("Emacs", new String[][]{
      ...
      {"control D",                "$Delete", "Diff.ShowDiff", "Compare.SameVersion", "CompareTwoFiles", "SendEOF", "Terminal.CloseSession",
                                   "FileChooser.GotoDesktop", "org.jetbrains.r.console.RConsoleViewImpl.REofAction"},
      {"control E",                "EditorLineEnd", "Terminal.MoveCaretToLineEnd"},
      ...
      {"control SPACE",            "EditorToggleStickySelection", "ChangesView.SetDefault", "Console.TableResult.SelectColumn"},
      ...
      {"control alt G",            "GotoDeclaration", "org.jetbrains.plugins.ruby.rails.actions.generators.RailsRunGeneratorPopupAction"},
    ...
    Map.entry("Visual Studio OSX", new String[][]{
      ...
      {"F7",                       "CompileDirty", "NextDiff"},
      {"meta ENTER",               "Console.Execute.Multiline", "DirDiffMenu.SynchronizeDiff.All", "Docker.RemoteServers.StartComposeService", "EditorStartNewLineBefore", "NotebookInsertCodeCellAction", "SplitChooser.Duplicate", "Terminal.SmartCommandExecution.Run", "ViewSource", "org.jetbrains.r.actions.RunSelection", "GraphQLExecuteEditor"},
    ...
    Map.entry("Eclipse", new String[][]{
      ...
      {"control D",                "EditorDeleteLine", "Diff.ShowDiff", "Compare.SameVersion", "CompareTwoFiles", "SendEOF", "Terminal.CloseSession",
                                   "FileChooser.GotoDesktop", "org.jetbrains.r.console.RConsoleViewImpl.REofAction"},
    ...
    Map.entry("Eclipse (Mac OS X)", new String[][]{
      ...
      {"meta D",                   "EditorDeleteLine", "Diff.ShowDiff", "Compare.SameVersion", "CompareTwoFiles", "SendEOF", "FileChooser.GotoDesktop"},
    ...
    Map.entry("Sublime Text", new String[][]{
      ...
      {"ctrl D",                   "CompareTwoFiles", "Diff.ShowDiff", "Compare.SameVersion", "FileChooser.GotoDesktop", "SelectNextOccurrence", "SendEOF",
                                   "Terminal.CloseSession", "org.jetbrains.r.console.RConsoleViewImpl.REofAction"},
    ...
    Map.entry("Sublime Text (Mac OS X)", new String[][]{
      ...
      {"meta D",                   "CompareTwoFiles", "Diff.ShowDiff", "Compare.SameVersion", "FileChooser.GotoDesktop", "SelectNextOccurrence", "SendEOF"},
      {"meta DOWN",                "EditorTextEnd", "Terminal.SelectPrompt", "Terminal.LineDown", "NotebookSelectCellBelowAction"},
      {"meta ENTER",               "Console.Execute.Multiline", "DirDiffMenu.SynchronizeDiff.All", "EditorStartNewLine", "ViewSource",
                                   ...
                                   "Docker.RemoteServers.StartComposeService", "GraphQLExecuteEditor", "NotebookInsertCodeCellAction"},
      ...
      {"meta UP",                  "EditorTextStart", "FileChooser.GoToParent", "Terminal.SelectLastBlock", "Terminal.SelectBlockAbove", "Terminal.LineUp", "NotebookSelectCellAboveAction"},
      ...
      {"meta alt G",               "DatabaseView.SqlGenerator", "FindWordAtCaret", "org.jetbrains.plugins.ruby.rails.actions.generators.RailsRunGeneratorPopupAction"},
      {"meta alt RIGHT",           "AIAssistant.Editor.AcceptOneLineCompletion", "NextTab"},
    ...
    Map.entry("macOS System Shortcuts", new String[][]{
      {"ctrl C",                   "Terminal.ClearPrompt", "Vcs.QuickListPopupAction", "org.jetbrains.r.console.RConsoleViewImpl.RInterruptAction"},
      ...
      {"meta DOWN",                "EditSourceNotInEditor", "EditorTextEnd", "Terminal.SelectPrompt", "Terminal.LineDown", "NotebookSelectCellBelowAction"},
      ...
      {"meta UP",                  "EditorTextStart", "FileChooser.GoToParent", "NotebookSelectCellAboveAction", "Terminal.SelectLastBlock", "Terminal.SelectBlockAbove", "Terminal.LineUp"},
      {"meta alt DOWN",            "Console.TableResult.NextPage", "NextOccurence"},
