...
/**
 * @deprecated Use com.intellij.platform.structureView.frontend.actions.ViewStructureAction or
 * com.intellij.platform.structureView.backend.StructurePopupHelper.showFileStructurePopup instead
 */
@Deprecated
public final class ViewStructureAction extends DumbAwareAction {
  ...
  public static @NotNull StructureViewModel createStructureViewModel(@NotNull Project project,
    ...
    return StructurePopupUtil.createStructureViewModel(project, fileEditor, structureView);
  }
}