...
val IdeInfo.Companion.PyCharm: IdeInfo
  get() {
    PyCharmDevBuildServerListener.init()
 ...
 */
class PyCharmDevBuildServerListener : TestExecutionListener {
  companion object {
    init {
      init()
    }
    ...
    fun init() {
      initDevBuildServerDiBinding(IdeInfoType.PYCHARM, DefaultPyCharm)
    }
  }
}
